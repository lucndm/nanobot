...
- **deploy** (`.claude/skills/deploy/SKILL.md`): Deploy nanobot to production (unraid) via Komodo GitOps. Covers source sync, image build, config management, and deploy verification. Invoke when user says "deploy", "release", "push to production".
